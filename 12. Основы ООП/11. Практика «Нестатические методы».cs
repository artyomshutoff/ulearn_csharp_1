...
public class Vector
{
    ...
    public Vector Add(Vector vector) { return Geometry.Add(this, vector); }
...
public class Geometry
{
    ...
    {
        return new Vector{ X = vector1.X + vector2.X,
    ...
    public static double GetLength(Segment segment)
    {
        ...
        return Math.Sqrt(segmentLengthX * segmentLengthX +
                         segmentLengthY * segmentLengthY);
    }
    ...
    public static bool IsVectorInSegment(Vector vector, Segment segment)
    {
        ...
        return GetLength(segment) ==
               (GetLength(segment1) + GetLength(segment2));
    }
}
}